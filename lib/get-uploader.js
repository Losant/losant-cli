...
const getUploader = ({
  ...
  const uploader = async (pattern, opts = {}, cmd, loadedConfig) => {
    ...
    if (meta === null) { // null means that no configuration file was found
      return logError('Configuration file expected but not found, please re-configure your directory');
    }
    let items;
    try {
