...
let spy;
const { remove, pathExists, writeFile } = require('fs-extra');
...
describe('Experiene Commands', () => {
  ...
  // before(async () => {
  //   if (await pathExists('./losant.yml')) {
  //     await remove('./losant.yml');
  //   }
  //   if (await pathExists('./experience/')) {
  //     await remove('./experience/');
  //   }
