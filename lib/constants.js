...
module.exports = {
  ...
  files: {
    ...
    remoteStatusParams: [ (resource) => `files${resource.parentDirectory}${resource.name}`, 's3etag', { skipMd5Creation: true } ]
  },
  dataTables: {
  ...
  options: {
    ...
    reset: ['-r, --reset', 'delete all local files and redownload']
  }
};
