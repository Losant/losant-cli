...
module.exports = {
  experience: {
    ...
    localStatusParams: [ path.join(path.sep, '**', '*.hbs') ],
  ...
  options: {
    ...
    viewType: [ '--type [viewType]', 'the type of experience view you want to upload e.g. layouts, pages or components', /^(layouts|pages|components)$/i ]
  }
};
