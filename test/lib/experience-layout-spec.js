...
describe('#ExperienceLayout', () => {
  ...
  it('it should update a one page\'s layout', async () => {
    ...
    sinon.stub(inquirer, 'prompt').callsFake(() => {
      return Promise.resolve({ name: 'Another Layout https://app.losant.space/applications/5b9297591fefb200072e554d/experience/versions/develop/views/layouts/5c0a9a163fb78400095ec089' });
    });
    ...
    sinon.stub(inquirer, 'prompt').callsFake((config) => {
      if (config[0].type === 'list') {
        ...
        return Promise.resolve({
          pageKey: [
            'Home Page https://app.losant.space/applications/5b9297591fefb200072e554d/experience/versions/develop/views/pages/5b92975d376bb800087d1f50',
            'Log In https://app.losant.space/applications/5b9297591fefb200072e554d/experience/versions/develop/views/pages/5b92975dc2f8de0006e2ca94'
          ]
        });
      }
    });
